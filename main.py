...
#tile_image_size = 128
#tile_size = 132		# Should be multiple of two

scale_factor = 1									# PC	
#scale_factor = 4									# Android

tile_image_size = 32 * scale_factor
tile_size = 34 * scale_factor

font_size = 16 * scale_factor

visible_rows = 8

size = width, height = tile_size*5, tile_size*9		# PC
#size = width, height = 800, 1200						# Android
...
icon = pygame.image.load("assets/android-icon.png").convert_alpha()
...
def load_surface(path, width, height):
	surface = pygame.image.load(path).convert_alpha()
	surface = pygame.transform.scale(surface, [width, height])
	return surface

def load_surface_scale(path, scale):
	surface = pygame.image.load(path).convert_alpha()
...
def load_sliced_sprites(filename, w, h):
	...
	scale = float(h) / float(master_height)
	
	master_image = pygame.transform.scale(master_image, [int(master_width * scale), int(master_height * scale)])
...
title_card = load_surface_scale("assets/title.png", scale_factor)
button_storymode = load_surface_scale("assets//button_storymode.png", scale_factor)
button_endlessmode = load_surface_scale("assets//button_endlessmode.png", scale_factor)
button_howto = load_surface_scale("assets//button_howto.png", scale_factor)
	
aggro_overlay = load_surface("assets/aggro.png", tile_image_size, tile_image_size)
stun_overlay = load_surface("assets/stun_1.png", tile_image_size, tile_image_size)
defend_overlay = load_surface("assets/defending.png", tile_image_size, tile_image_size)
selection_overlay = load_surface("assets/selection.png", tile_image_size, tile_image_size)
action_select_overlay = load_surface("assets/action_select.png", tile_image_size, tile_image_size)
skill_inactive_overlay = load_surface("assets/inactive.png", tile_image_size, tile_image_size)
equip_overlay = load_surface("assets/equip.png", tile_image_size, tile_image_size)
broken_overlay = load_surface("assets//broken.png", tile_image_size, tile_image_size)
range_overlay = load_surface("assets/range_overlay.png", tile_image_size, tile_image_size)

attack_images = load_sliced_sprites("assets/DS_Attack.png", tile_image_size, tile_image_size)
fireball_images = load_sliced_sprites("assets/DS_Fireball.png", tile_image_size, tile_image_size)
...
class DS_SurfaceManager:
	...
	player_surfaces.append(load_surface("sprite/player.png", tile_image_size, tile_image_size))
	
	
	heart_surfaces = []
	heart_surfaces.append(load_surface("sprite/heart_1.png", tile_image_size, tile_image_size))
	heart_surfaces.append(load_surface("sprite/heart_2.png", tile_image_size, tile_image_size))
	heart_surfaces.append(load_surface("sprite/heart_3.png", tile_image_size, tile_image_size))
	heart_surfaces.append(load_surface("sprite/heart_4.png", tile_image_size, tile_image_size))
	
	blankheart_surfaces = []
	blankheart_surfaces.append(load_surface("sprite//blankheart_1.png", tile_image_size, tile_image_size))
	blankheart_surfaces.append(load_surface("sprite//blankheart_2.png", tile_image_size, tile_image_size))
	blankheart_surfaces.append(load_surface("sprite//blankheart_3.png", tile_image_size, tile_image_size))
	blankheart_surfaces.append(load_surface("sprite//blankheart_4.png", tile_image_size, tile_image_size))
	
	for i in range(len(blankheart_surfaces)):
		blankheart_surfaces[i] = pygame.transform.scale(blankheart_surfaces[i], [tile_image_size, tile_image_size])
	
	# Enemy Surfaces
	#-------------------------------------------------------------------#
	enemy_spider = []
	enemy_spider.append(load_surface("sprite/enemy_spider_1.png", tile_image_size, tile_image_size))
	enemy_spider.append(load_surface("sprite/enemy_spider_2.png", tile_image_size, tile_image_size))
	enemy_spider.append(load_surface("sprite/enemy_spider_3.png", tile_image_size, tile_image_size))
	
	enemy_snake = []
	enemy_snake.append(load_surface("sprite/enemy_snake_1.png", tile_image_size, tile_image_size))
	enemy_snake.append(load_surface("sprite/enemy_snake_2.png", tile_image_size, tile_image_size))
	enemy_snake.append(load_surface("sprite/enemy_snake_3.png", tile_image_size, tile_image_size))
	
	enemy_crab = []
	enemy_crab.append(load_surface("sprite/enemy_crab_1.png", tile_image_size, tile_image_size))
	enemy_crab.append(load_surface("sprite/enemy_crab_2.png", tile_image_size, tile_image_size))
	
	enemy_slime = []
	enemy_slime.append(load_surface("sprite/enemy_slime_1.png", tile_image_size, tile_image_size))
	enemy_slime.append(load_surface("sprite/enemy_slime_2.png", tile_image_size, tile_image_size))
	enemy_slime.append(load_surface("sprite/enemy_slime_3.png", tile_image_size, tile_image_size))
	
	enemy_jelly = []
	enemy_jelly.append(load_surface("sprite/enemy_jelly_1.png", tile_image_size, tile_image_size))
	enemy_jelly.append(load_surface("sprite/enemy_jelly_2.png", tile_image_size, tile_image_size))
	enemy_jelly.append(load_surface("sprite/enemy_jelly_3.png", tile_image_size, tile_image_size))
	
	enemy_wolf = []
	enemy_wolf.append(load_surface("sprite/enemy_wolf_1.png", tile_image_size, tile_image_size))
	enemy_wolf.append(load_surface("sprite/enemy_wolf_2.png", tile_image_size, tile_image_size))
	enemy_wolf.append(load_surface("sprite/enemy_wolf_3.png", tile_image_size, tile_image_size))
	
	enemy_orc = []
	enemy_orc.append(load_surface("sprite/enemy_orc_1.png", tile_image_size, tile_image_size))
	enemy_orc.append(load_surface("sprite/enemy_orc_2.png", tile_image_size, tile_image_size))
	enemy_orc.append(load_surface("sprite/enemy_orc_3.png", tile_image_size, tile_image_size))
	
	enemy_stalker = []
	enemy_stalker.append(load_surface("sprite/enemy_stalker_1.png", tile_image_size, tile_image_size))
	enemy_stalker.append(load_surface("sprite/enemy_stalker_2.png", tile_image_size, tile_image_size))
	enemy_stalker.append(load_surface("sprite/enemy_stalker_3.png", tile_image_size, tile_image_size))

	enemy_horror = []
	enemy_horror.append(load_surface("sprite/enemy_horror_1.png", tile_image_size, tile_image_size))
	enemy_horror.append(load_surface("sprite/enemy_horror_2.png", tile_image_size, tile_image_size))
	enemy_horror.append(load_surface("sprite/enemy_horror_3.png", tile_image_size, tile_image_size))
	
	enemy_undead = []
	enemy_undead.append(load_surface("sprite/enemy_undead_1.png", tile_image_size, tile_image_size))
	enemy_undead.append(load_surface("sprite/enemy_undead_2.png", tile_image_size, tile_image_size))
	enemy_undead.append(load_surface("sprite/enemy_undead_3.png", tile_image_size, tile_image_size))
	
	enemy_demon = []
	enemy_demon.append(load_surface("sprite/enemy_demon_1.png", tile_image_size, tile_image_size))
	enemy_demon.append(load_surface("sprite/enemy_demon_2.png", tile_image_size, tile_image_size))
	enemy_demon.append(load_surface("sprite/enemy_demon_3.png", tile_image_size, tile_image_size))
	
	enemy_dragon = []
	enemy_dragon.append(load_surface("sprite/enemy_dragon_1.png", tile_image_size, tile_image_size))
	enemy_dragon.append(load_surface("sprite/enemy_dragon_2.png", tile_image_size, tile_image_size))
	enemy_dragon.append(load_surface("sprite/enemy_dragon_3.png", tile_image_size, tile_image_size))
	#-------------------------------------------------------------------#
	
	# Boss surfaces
	#-------------------------------------------------------------------#
	boss = []
	boss.append(load_surface("sprite//boss_1_troll.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_2_beholder.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_3_mindflayer.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_4_greendragon.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_5_towerknight.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_6_deathknight.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_7_dreadknight.png", tile_image_size, tile_image_size))
	boss.append(load_surface("sprite//boss_8_necromancer.png", tile_image_size, tile_image_size))
	#-------------------------------------------------------------------#
	
	# Weapon surfaces
	#-------------------------------------------------------------------#
	weapon_fist = load_surface("sprite/weapon_fist.png", tile_image_size, tile_image_size)
	weapon_melee = []
	weapon_melee.append(load_surface("sprite/weapon_melee_1.png", tile_image_size, tile_image_size))
	weapon_melee.append(load_surface("sprite/weapon_melee_2.png", tile_image_size, tile_image_size))
	weapon_melee.append(load_surface("sprite/weapon_melee_3.png", tile_image_size, tile_image_size))
	weapon_melee.append(load_surface("sprite/weapon_melee_4.png", tile_image_size, tile_image_size))
	weapon_melee.append(load_surface("sprite/weapon_melee_5.png", tile_image_size, tile_image_size))
	
	weapon_ranged = []
	weapon_ranged.append(load_surface("sprite/weapon_ranged_1.png", tile_image_size, tile_image_size))
	weapon_ranged.append(load_surface("sprite/weapon_ranged_2.png", tile_image_size, tile_image_size))
	weapon_ranged.append(load_surface("sprite/weapon_ranged_3.png", tile_image_size, tile_image_size))
	weapon_ranged.append(load_surface("sprite/weapon_ranged_4.png", tile_image_size, tile_image_size))
	weapon_ranged.append(load_surface("sprite/weapon_ranged_5.png", tile_image_size, tile_image_size))
	
	weapon_stunner = []
	weapon_stunner.append(load_surface("sprite/weapon_stunner_1.png", tile_image_size, tile_image_size))
	weapon_stunner.append(load_surface("sprite/weapon_stunner_2.png", tile_image_size, tile_image_size))
	weapon_stunner.append(load_surface("sprite/weapon_stunner_3.png", tile_image_size, tile_image_size))
	weapon_stunner.append(load_surface("sprite/weapon_stunner_4.png", tile_image_size, tile_image_size))
	
	#-------------------------------------------------------------------#

	skill_surfaces = []

	skill_surfaces.append(load_surface("sprite/skill_defend.png", tile_image_size, tile_image_size))
	skill_surfaces.append(load_surface("sprite/skill_divine_shield.png", tile_image_size, tile_image_size))
	
	
	pickup_surfaces = []
	
	pickup_surfaces.append(load_surface("sprite/pickup_treasure.png", tile_image_size, tile_image_size))
	pickup_surfaces.append(load_surface("sprite/pickup_weapon_chest.png", tile_image_size, tile_image_size))
	pickup_surfaces.append(load_surface("sprite/pickup_cross.png", tile_image_size, tile_image_size))
	
	
	item_surfaces = []
	
	item_surfaces.append(load_surface("sprite/spell_heal.png", tile_image_size, tile_image_size))
	item_surfaces.append(load_surface("sprite/spell_magicmissile.png", tile_image_size, tile_image_size))
	
	spell_surfaces = {}
	spell_surfaces['aura'] = load_surface("sprite/spell_aura.png", tile_image_size, tile_image_size)
	spell_surfaces['coldblast'] = load_surface("sprite/spell_coldblast.png", tile_image_size, tile_image_size)
	spell_surfaces['deathscroll'] = load_surface("sprite/spell_deathscroll.png", tile_image_size, tile_image_size)
	spell_surfaces['holyscroll'] = load_surface("sprite/spell_holyscroll.png", tile_image_size, tile_image_size)
	spell_surfaces['invisibility'] = load_surface("sprite/spell_invisibility.png", tile_image_size, tile_image_size)
	spell_surfaces['magicmissile'] = load_surface("sprite/spell_magicmissile.png", tile_image_size, tile_image_size)
	spell_surfaces['heal'] = load_surface("sprite/spell_heal.png", tile_image_size, tile_image_size)
	spell_surfaces['petrify'] = load_surface("sprite/spell_petrify.png", tile_image_size, tile_image_size)
	spell_surfaces['petrify'] = load_surface("sprite/spell_petrify.png", tile_image_size, tile_image_size)
	spell_surfaces['drain'] = load_surface("sprite/spell_drain.png", tile_image_size, tile_image_size)
	spell_surfaces['fireball'] = load_surface("sprite/spell_fireball.png", tile_image_size, tile_image_size)
	spell_surfaces['forceblast'] = load_surface("sprite/spell_forceblast.png", tile_image_size, tile_image_size)
	
	barrier_surfaces = []
	
	barrier_surfaces.append(load_surface("sprite//barrier_column.png", tile_image_size, tile_image_size))
	barrier_surfaces.append(load_surface("sprite//barrier_divine_shield_left.png", tile_image_size, tile_image_size))
	barrier_surfaces.append(load_surface("sprite//barrier_divine_shield_right.png", tile_image_size, tile_image_size))
	barrier_surfaces.append(load_surface("sprite//barrier_divine_shield_up.png", tile_image_size, tile_image_size))
	
	exit_surfaces = []
	
	exit_surfaces.append(load_surface("sprite/location_exit.png", tile_image_size, tile_image_size))
...
class DS_Weapon(DS_Action):		
	...
	def draw(self):
		...
		screen.blit(info, [self.rect.midright[0] - tile_size/2, self.rect.midleft[1]])
...
class DS_Item(DS_Action):
	...
	def draw(self):
		...
		info_string = str(self.level + 1)
		info = myfont.render(info_string, 1, (255,255,0))
		screen.blit(info, [self.rect.midright[0] - tile_size/3, self.rect.midleft[1]])
...
class DS_Spell_Petrify(DS_Item):
	...
	def multi_action(self, user, targets):
		...
		for pair in targets:
			if not isinstance(pair.tile(), DS_Location_Exit):
...
class DS_Spell_ForceBlast(DS_Item):
	...
	def multi_action(self, user, streams):
		for i in range (len(streams)):
			if isinstance(streams[i][0], DS_Enemy):
				streams[i][0].set_stun()
				streams[i][0].stun_timer = self.level
			if i == 0 or i == 2 or i == 4:
				if isinstance(streams[i][1], DS_Enemy):
					streams[i][1].set_stun()
					streams[i][1].stun_timer = self.level
...
class DS_GameManager:
	...
	left_stream = DS_Stream([width/2.0 - tile_size, tile_size * 5 + tile_size/2], 0)
	right_stream = DS_Stream([width/2.0 + tile_size, tile_size * 5 + tile_size/2], 2)
	
	vert_center_stream = DS_Stream([width/2.0, tile_size * 4 + tile_size/2], 1)
	
	vert_left_stream = DS_Stream([width/2.0 - tile_size, tile_size * 4 + tile_size/2], 1)
	left_stream_changed = False
	
	vert_right_stream = DS_Stream([width/2.0 + tile_size, tile_size * 4 + tile_size/2], 1)
	...
	difficulty = 0						# Normal and Hard mode
	...
	def init_game(self):
		...
		if self.difficulty_hard():
			...
			self.weapons.append(DS_Weapon_Stunner(0, self.player))
		...
		if self.difficulty_hard():
			self.items.append(DS_Spell_MagicMissile(1))
			self.items.append(DS_Spell_ForceBlast(0))
		
		# Set player position
		self.player.rect.center = [width/2.0, tile_size * 5 + tile_size/2] 
	...
	def add_to_stream_endless(self, stream):
		if self.exit_inplay:
			stream.append(DS_Barrier_Column())
		else:
	...
	def enemy_quota_met(self):
		#if len(self.center_enemies_killed) >= self.enemy_quota:				# Old - only count center enemies
		if len(self.stat_enemies_killed) >= self.enemy_quota:
			return True
		else:
			return False
	...
	def drop_tiles(self):
		...
		if isinstance(self.left_stream[0], DS_Barrier): 
			if isinstance(self.vert_left_stream[0], DS_Barrier):
				...
				self.left_stream[1].rect.center = [self.vert_left_stream.pos[0], self.vert_left_stream.pos[1]]
				
				self.left_stream[1].add_keyframe([self.vert_left_stream.pos[0] - tile_size, self.vert_left_stream.pos[1]])
			...
			self.left_stream[0].rect.center = [self.vert_left_stream.pos[0], self.vert_left_stream.pos[1]]
		...
		if isinstance(self.right_stream[0], DS_Barrier):
			if isinstance(self.vert_right_stream[0], DS_Barrier):
				...
				self.right_stream[1].rect.center = [self.vert_right_stream.pos[0], self.vert_right_stream.pos[1]]
				
				self.right_stream[1].add_keyframe([self.vert_right_stream.pos[0] + tile_size, self.vert_right_stream.pos[1]])
			...
			self.right_stream[0].rect.center = [self.vert_right_stream.pos[0], self.vert_right_stream.pos[1]]
	...
	def update_menuitem_positions(self):
		...
		for i in range(len(self.skills)):
			self.skills[i].rect.center = [width/2.0, tile_size * 6 + tile_size * i + tile_size/2.0]
		
		# Update items positions
		for i in range(len(self.items)):
			if i == 0 or i == 1:
				self.items[i].rect.center = [width/2.0 + tile_size + tile_size * i, tile_size * 6 + tile_size/2.0]
			elif i == 2:
				self.items[i].rect.center = [width/2.0 + tile_size, tile_size * 7 + tile_size/2.0]
				
		# Update weapons positions
		for i in range(len(self.weapons)):
			if i == 0 or i == 1:
				self.weapons[i].rect.center = [width/2.0 - (tile_size + tile_size * i), tile_size * 6 + tile_size/2.0]
			elif i == 2:
				self.weapons[i].rect.center = [width/2.0 - tile_size, tile_size * 7 + tile_size/2.0]
	...
	def enemy_aggro(self):
		...
		# Hard mode - second enemy in vert_center, right, and left streams also aggro
		if self.difficulty == 1:
			if isinstance(self.left_stream[1], DS_Enemy):
				self.left_stream[1].react(self.player)
			if isinstance(self.right_stream[1], DS_Enemy):
				self.right_stream[1].react(self.player)
			if isinstance(self.vert_center_stream[1], DS_Enemy):
				self.vert_center_stream[1].react(self.player)
	...
	def enemy_deaggro(self):
		...
		for tile in self.left_stream[2:]:
			if isinstance(tile, DS_Enemy):
				if not tile.is_stun():
					tile.set_neutral()
		for tile in self.right_stream[2:]:
			if isinstance(tile, DS_Enemy):
				if not tile.is_stun():
					tile.set_neutral()
		for tile in self.vert_center_stream[2:]:
			if isinstance(tile, DS_Enemy):
				if not tile.is_stun():
					tile.set_neutral()
	...
	def draw_health(self):
		for i in range(int(self.player.get_max_health())):
			screen.blit(SurfaceManager.blankheart_surfaces[i % 4], (2 * scale_factor, tile_size*(int(i/4))))
			
		for i in range(int(self.player.get_health())):
			screen.blit(SurfaceManager.heart_surfaces[i % 4], (2 * scale_factor, tile_size*(int(i/4))))
			
	def draw_range_overlay(self):
		if self.active_action != None and self.active_action.get_range() > 0:
			for i in range(self.active_action.get_range()):
				screen.blit(range_overlay, self.vert_center_stream[i].rect.topleft)
					
				
				screen.blit(range_overlay, self.left_stream[i].rect.topleft)
				screen.blit(range_overlay, self.right_stream[i].rect.topleft)
					
				
				if i < self.active_action.get_range() - 1:
					screen.blit(range_overlay, self.vert_left_stream[i].rect.topleft)
					screen.blit(range_overlay, self.vert_right_stream[i].rect.topleft)
	...
	def draw_gui(self):
		...
		score_info = myfont.render(str(int(self.score)) + " L" + str(self.levels_completed + 1), 1, (255,255,0))
		...
		screen.blit(multiplier_info, (width - (4 * scale_factor) - len(multiplier_string) * font_size / 2, 10))
		
		# Draw selection box
		if self.selected_tile != None:
			tile_info = myfont.render(self.selected_tile.get_info(), 1, (255,255,0))
			screen.blit(tile_info, (10, tile_size * visible_rows + font_size))
...
#GameManager.set_difficulty_hard()
	
#debug()


def check_swipe(startpos, endpos):
	vector = [endpos[0] - startpos[0], endpos[1] - startpos[1]]
	if abs(vector[0]) < width/15.0 and abs(vector[1]) < height/15.0:
		return None
...
def main():
	...
	myfont = pygame.font.Font("Magic Forest.ttf", font_size)
	...
	while 1:
		...
		for event in pygame.event.get():
			...
			if event.type == MOUSEBUTTONDOWN:
				if event.button == 1:
					TOUCH_LOCK = True
					TOUCH_DOWN = event.pos
					
			if event.type == MOUSEBUTTONUP:
				if event.button == 1:
					TOUCH_LOCK = False
					swipe_dir = check_swipe(TOUCH_DOWN, event.pos)
					
					if swipe_dir != None and GameManager.active():
						GameManager.handle_key(swipe_dir)
